...
JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
    ...
    <title>Ejercicio 5 - ver</title>
</head>

<body>
    <header>
        <div class="row align-items-center text-center" style="background-color:lightseagreen; height: 100px;">
            <div class="col-12">
    ...
    Usuario registrado:
    <?php 
    echo 'Usuario: '  .$_SESSION['Usuario'] .' - Contraseña: '. $_SESSION['Pass'];
    ?>  
    <br>
    
    <a href="form.html" class="btn btn-success">Volver al inicio</a>
</body>
